...
For example, if the assembly `DevExpress.Xpf.Ribbon.v18.1.dll` directly references `DevExpress.Data.v18.1.dll`, `DevExpress.Mvvm.v18.1.dll` and `DevExpress.Xpf.Core.v18.1.dll`, the NuGet specification will declare a dependency to each of the three NuGet packages corresponding to these assemblies:
    ...
    <package xmlns="http://schemas.microsoft.com/packaging/2012/06/nuspec.xsd">
      <metadata>
        ...
        <version>18.1.5.0</version>
        <!-- ... (omitted for brevity) -->
        <dependencies>
          <group targetFramework=".NETFramework4.0">
            <dependency id="Unofficial.DevExpress.Xpf.Core" version="18.1.5.0" />
            <dependency id="Unofficial.DevExpress.Data" version="18.1.5.0" />
            <dependency id="Unofficial.DevExpress.Mvvm" version="18.1.5.0" />
          </group>
       </dependencies>
      </metadata>
      <files>
 ...
 * **v18.1.5.0** - 2018-08-05
   - Contains NuGet specs for the DevExpress Components 18.1.5 released on August 1, 2018
